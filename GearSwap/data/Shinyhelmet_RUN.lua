...
function init_gear_sets()
	...
	sets.baseTank = {                     --Total: 54 | DT44 | PDT10
		ammo="Staunch Tathlum",        --DT03  * normal need +1 
		head="Nyame Helm",                --DT07  *
		body="Runeist's Coat +3",
		hands="Turms Mittens +1",             -- * need +1 
		legs="Erilaz Leg Guards +3",      --DT12
	...
	sets.baseEnmity = {                             --Toal: 95+23   DT:37+25  (+ from epeo)
		...
		legs="Erilaz Leg Guards +3",      --11  *                    P07
...
function init_modetables()
	...
	weaponMode = {
		...
		[5] = {name="Trial", set={main="Sword of Trials", sub="Utu Grip"}},
	}
