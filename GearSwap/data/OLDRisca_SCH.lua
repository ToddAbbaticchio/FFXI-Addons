...
function init_gear_sets()
    ...
    sets.midcast['Regen'] = set_combine(sets.midcast['Enhancing Magic'], {head="Arbatel Bonnet +2", main="Bolelabunga"})
...
function update_IdleEngagedSets(gearMode, modeModifier)
	...
	if modeModifier == 'Burst' then
		...
		enable('main', 'sub')
		sets.midcast['Elemental Magic'] = sets.freeCast
	end
	evalState_equipGear()
end
